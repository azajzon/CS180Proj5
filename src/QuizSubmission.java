...
/**
 * Project 4 - QuizSubmission
 * <p>
 * The QuizSubmission class implements Serializable and gets the array list of answers, quiz name, course name and finds the answer based on the question.
...
public class QuizSubmission implements Serializable {
    ...
    //Constructs a newly allocated QuizSubmission object with the field values specified by the input parameters
    ...
    public Answer findAnswer(String questionTitle) {
        for(Answer answer: answers) {
            // checks if the question is equal to the question the student answers and based on that it returns the answer
