...
public class Course implements Serializable {
    ...
    // Constructs a newly allocated Server.Course object with the field values specified by the input parameters.
    ...
    public Quiz getQuiz(String quizName) {
        //for each loop with a quiz object to check if the
        //name of the quiz the user typed in is equal to the one that the teacher creates
